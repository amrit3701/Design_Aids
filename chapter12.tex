...
Provided $225 \times 225$ base and
        ...
        \tablemacro \ref{chaptertable} gives for p = 0.02, and steel
        \Fefouronefivemacro,
...
with $y > L_d$ (tension), footing bars will develop full strength at the 
critical section.

It may be noted that with $D$ = 50 $cm$, this type of footing of uniform
depth is not economical. Footing of Types ($b$) and ($c$) with sloping 
depth would be more economical than the present design.
\end{enumerate}
